...
Usage examples:
  python fetch_and_send_gmuni_payments_enre_status.py --password YOUR_PASSWORD
  python fetch_and_send_gmuni_payments_enre_status.py --password YOUR_PASSWORD --db P_CUALE_KIA_LINDAVISTA
  python fetch_and_send_gmuni_payments_enre_status.py --password YOUR_PASSWORD --dry-run --verbose
"""
...
def print_transform_stats(stats: Dict[str, int]) -> None:
    ...
    print(f"  Skipped empty status:  {stats['missing_enre_status']}")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Fetch GMUni payments with ENRE_STATUS and send to /payments"
    )
