#!/usr/bin/env python3
"""Fetch Universidad flattened sales rows and cancel orders marked as cancelled."""
...
from universidad_common import (
    add_api_args,
    add_source_args,
    build_order_cancellation_targets,
    cancel_targets,
    load_source_rows,
    require_auth_args,
    TokenManager,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Fetch Universidad rows and cancel orders through /orders/{id}/cancel"
    )
    ...
    try:
        ...
        targets, stats = build_order_cancellation_targets(
            rows,
